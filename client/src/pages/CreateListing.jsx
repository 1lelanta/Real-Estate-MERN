    ...
    <main className='p-3 max-w-4xl mx-auto gap-4'>
        ...
        <form className='flex flex-col sm:flex-row gap-4'>
            <div className="flex flex-col gap-4 flex-1">
                ...
                <div className='flex gap-2 flex-wrap gap-6'>
                    ...
                    <div className='flex items-center gap-2'>
                        <input type="number" id='bathroomms' min='1' max='10' required
                        className='p-3 border border-gray-500 rounded-lg'/>
                        <p>baths</p>
                    </div>
                    <div className='flex items-center gap-2'>
                ...
                <div className='flex flex-col flex-1 gap-4'>
                    ...
                    <div className='flex gap-4'>
                        ...
                        <button className='p-3 bg-slate-700 text-white rounded-lg uppercase font-bold
